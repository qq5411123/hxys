...
$args = array('pagesize' => 28, 'page' => $_GPC['page'], 'isnew' => $_GPC['isnew'], 'ishot' => $_GPC['ishot'], 'isrecommand' => $_GPC['isrecommand'], 'isdiscount' => $_GPC['isdiscount'], 'istime' => $_GPC['istime'], 'keywords' => $_GPC['keywords'], 'pcate' => intval($_GPC['pcate']), 'ccate' => intval($_GPC['ccate']), 'tcate' => intval($_GPC['tcate']), 'pcate1' => intval($_GPC['pcate1']), 'ccate1' => intval($_GPC['ccate1']), 'tcate1' => intval($_GPC['tcate1']), 'order' => $_GPC['order'], 'by' => $_GPC['by']);
