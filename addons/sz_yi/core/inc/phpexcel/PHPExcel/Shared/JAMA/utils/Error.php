...
$error['FR'][PolymorphicArgumentException] = 'Modèle inadmissible d\'argument pour la fonction polymorphe.' . $error['DE'][PolymorphicArgumentException] = 'Unzul"assiges Argumentmuster für polymorphe Funktion.';
...
$error['DE'][ArgumentTypeException] = 'Unzul"assige Argumentart.';
...
$error['DE'][ArgumentBoundsException] = 'Unzul"assige Argumentstrecke.';
...
$error['DE'][MatrixDimensionException] = 'Matrixmasse sind nicht gleich.';
...
$error['DE'][PrecisionLossException] = 'Bedeutender Pr"azision Verlust ermittelte.';
...
$error['DE'][MatrixSPDException] = 'Bedeutender Pr"azision Verlust ermittelte.';
