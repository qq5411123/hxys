...
class PHPExcel_Reader_Excel2007 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	...
	static private function _castToBool($c)
	{
	...
	static private function _castToError($c)
	{
		return isset($c->v) ? (string) $c->v : NULL;
	}

	static private function _castToString($c)
	{
		return isset($c->v) ? (string) $c->v : NULL;
	}
	...
	static private function _readStyle($docStyle, $style)
	{
	...
	static private function _readBorder($docBorder, $eleBorder)
	{
	...
	static private function boolean($value = NULL)
	{
		if (is_numeric($value)) {
			return (bool) $value;
		}
