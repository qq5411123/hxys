    ...
    <div class="main">
        ...
        <div class='page'>
            ...
            <div class="topbar">
                ...
                <div class="search"><i class="iconfont icon-search" style="font-size: 22px"></i></div>
            </div>
...
<script id='tpl_goods_list' type='text/html'>
  <form action="" method="get" id="goodsform">
    ...
    <?php  if(is_array($goods)) { foreach($goods as $g) { ?>
     <?php $discount=$g['productprice'] > 0 && $g['marketprice'] > 0 ? number_format($g['marketprice']*10/$g['productprice'],1) : 0;?>
    <div class="good" data-goodsid='<?php  echo $g['id'];?>' style="position:relative;">
        ...
        <div class="price">￥<?php  echo $g['marketprice'];?> <?php  if($g['productprice']>0 && $g['marketprice']!=$g['productprice']) { ?><span>￥<?php  echo $g['productprice'];?></span><?php  } ?><?php  if($plugin_yunbi) { ?><?php  if($g['isforceyunbi'] == 1) { ?><?php  if(!empty($yunbi_set['yunbi_title'])) { ?><?php  echo $yunbi_set['yunbi_title']?><?php  } else { ?>云币<?php  } ?>:<?php  echo $g['yunbi_deduct']?><?php  } ?><?php  } ?></div>
