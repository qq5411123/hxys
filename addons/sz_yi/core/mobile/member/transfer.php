			...
			if (!file_exists($file)) {
				...
				if ($assigns) {
					if (empty($_GPC['yunbi'])) {
						...
						m('member')->setCredit($member['openid'], 'credit2', 0 - $money);
						$messages = array(
							'keyword1' => array('value' => '转赠通知', 'color' => '#73a68d'),
							'keyword2' => array('value' => '你向' . $assigns['nickname'] . '转赠金额' . $money . '元！', 'color' => '#73a68d')
							);
						...
						$messages = array(
							'keyword1' => array('value' => '转赠通知', 'color' => '#73a68d'),
							'keyword2' => array('value' => $member['nickname'] . '向你转赠金额' . $money . '元！', 'color' => '#73a68d')
							);
