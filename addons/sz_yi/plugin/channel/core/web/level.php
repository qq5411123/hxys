...
if ($operation == 'display') {
	...
	if (checksubmit('submit')) {
		...
		$data = array('uniacid' => $_W['uniacid'], 'level_name' => trim($_GPC['level_name']), 'level_num' => intval($_GPC['level_num']), 'purchase_discount' => intval($_GPC['purchase_discount']), 'min_price' => intval($_GPC['min_price']), 'profit_sharing' => intval($_GPC['profit_sharing']), 'become' => $set['become'], 'team_count' => intval($_GPC['team_count']), 'order_money' => $_GPC['order_money'], 'order_count' => intval($_GPC['order_count']), 'goods_id' => intval($_GPC['goods_id']));
