...
<div class="main rightlist">
    <form id="dataform" action="" method="post" class="form-horizontal form">
        ...
        <?php  echo tpl_form_field_category_level3('category', $parent, $children,0,0,0)?>
        <?php  } else { ?>
        <?php  echo tpl_form_field_category_level2('category', $parent, $children,0,0)?>
        <?php  } ?>
                    </div>
