    ...
    <div class='panel panel-default'>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select  class="form-control" name="setdata[culate_method]">
                        <option value="0" <?php  if(empty($set['culate_method'])) { ?>selected<?php  } ?>>原实付款金额</option>
                    ...
                    <span class='help-block'>原实付金额：包括优惠劵、满减、积分余额抵扣的金额，不包括邮费、会员折扣的金额</span>
                </div>
            </div>
        </div>
        <div class='panel-heading'>
        ...
        <div class='panel-body'>
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" value="<?php  echo $set['withdraw_proportion'];?>" name="setdata[withdraw_proportion]">
                    </div>
            ...
            <?php  } ?>
            <?php  if(p('love')) { ?> 
            <!-- Author:ym Date:2016-08-06 Content:消费天数 -->
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">消费天数</label>
                <div class="col-sm-9 col-xs-12">
                    <input class="form-control" type="text" value="<?php  echo $set['withdraw_day'];?>" name="setdata[withdraw_day]">
                    <span class="help-block">完成收货多少天后订单才计入已消费</span>
                </div>
            </div>
            <?php  } ?>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">开启提现到微信钱包</label>
                <div class="col-sm-9 col-xs-12">
                    <label class="radio-inline"><input type="radio"  name="setdata[closetowechatwallet]" value="0" <?php  if($set['closetowechatwallet'] ==0) { ?> checked="checked"<?php  } ?> /> 开启</label>
                    <label class="radio-inline"><input type="radio"  name="setdata[closetowechatwallet]" value="1" <?php  if($set['closetowechatwallet'] ==1) { ?> checked="checked"<?php  } ?> /> 关闭</label>
                    <span class="help-block">是否允许用户佣金提现到微信钱包</span>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">开启佣金提现到余额免审核</label>
                <div class="col-sm-9 col-xs-12">
                    <label class="radio-inline"><input type="radio"  name="setdata[creditnocheck]" value="1" <?php  if($set['creditnocheck'] ==1) { ?> checked="checked"<?php  } ?> /> 开启</label>
                    <label class="radio-inline"><input type="radio"  name="setdata[creditnocheck]" value="0" <?php  if($set['creditnocheck'] ==0) { ?> checked="checked"<?php  } ?> /> 关闭</label>
                    <span class="help-block">是否允许余额提现免审核</span>
                </div>
            </div>
            <!-- 提现免审核金额  不填写则需要审核  填写金额 则0-金额内可免审核自动打款 -->
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">提现审核限制</label>
                <div class="col-sm-9 col-xs-12">
                    <!-- <label class="radio-inline"><input type="radio"  name="setdata[closewithdrawcheck]" value="0" <?php  if($set['closewithdrawcheck'] ==0) { ?> checked="checked"<?php  } ?> /> 开启</label>
                    <label class="radio-inline"><input type="radio"  name="setdata[closewithdrawcheck]" value="1" <?php  if($set['closewithdrawcheck'] ==1) { ?> checked="checked"<?php  } ?> /> 关闭</label> -->
                    <input type="text" name="setdata[closewithdrawcheck]" class="form-control" value="<?php  echo $set['closewithdrawcheck'];?>"  />
     ...
     <div class="form-group">
           ...
           <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    ...
                    <span class="help-block">是否开启三级分销订单消息提醒功能，不开启上级有消息</span>
                </div> 
           </div>
...
<br/>               
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <!-- Author:ym Date:2016-08-15 Content:开启超级海报关注二维码 -->
           <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">关注二维码</label>
                <div class="col-sm-9 col-xs-12">
                    <label class="radio-inline"><input type="radio"  name="setdata[attention_qr]" value="0" <?php  if(empty($set['attention_qr'])) { ?> checked="checked"<?php  } ?> /> 关闭</label>
                    <label class="radio-inline"><input type="radio"  name="setdata[attention_qr]" value="1" <?php  if($set['attention_qr'] ==1) { ?> checked="checked"<?php  } ?> /> 开启</label>
                    <span class="help-block">是否开启超级海报中关注二维码为分销商的推广二维码</span>
                </div> 
           </div>
        </div>
           <div class='panel-heading'>
