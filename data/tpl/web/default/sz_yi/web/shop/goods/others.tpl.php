                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">打印机</label>
                              <div class="col-sm-9 col-xs-12">
                                <select name='print_id' class='form-control' id="print_id">
                                  <option value="">
                                      请选择打印机
                                  </option>
                                  <?php  if(is_array($print_list)) { foreach($print_list as $row) { ?>
                                  <option value="<?php  echo $row['id'];?>" <?php  if($item['print_id']!='' && $item['print_id']==$row['id']) { ?>selected="selected"<?php  } ?><?php  if($item['print_id']=='' && $row['type']==0) { ?>selected="selected"<?php  } ?>><?php  echo $row['name'];?></option>
                                  <?php  } } ?>
                                </select>
                                  <span class='help-block'>选择打印机</span>
                              </div>
                          </div>
                <?php  } ?><?php  } ?>
 <div class="form-group">
