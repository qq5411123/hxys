    ...
    <form  <?php if( ce('shop.category' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form" enctype="multipart/form-data" >
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="input-group ">
                            <input class="form-control" type="text" data-id="PAL-00010" placeholder="请填写指向的链接 (请以http://开头, 不填则不显示)" value="<?php  echo $item['advurl'];?>" name="advurl">
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">pc首页推荐分类广告</label>
                        <div class="col-sm-9 col-xs-12">
                            <?php if( ce('shop.category' ,$item) ) { ?>
                            <?php  echo tpl_form_field_image('advimg_pc', $item['advimg_pc'])?>
                            <span class="help-block">建议尺寸: 300*640</span>
                             <?php  } else { ?>
                               <?php  if(!empty($item['advimg_pc'])) { ?>
                                     <a href='<?php  echo tomedia($item['advimg_pc'])?>' target='_blank'>
                                    <img src="<?php  echo tomedia($item['advimg_pc'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                                     </a>
                               <?php  } ?>
                            <?php  } ?>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">pc首页推荐分类广告链接</label>
                        <div class="col-sm-9 col-xs-12">
                             <?php if( ce('shop.category' ,$item) ) { ?>
                            <div class="input-group ">
                                <input class="form-control" type="text" data-id="PAL-00010" placeholder="请填写指向的链接 (请以http://开头, 不填则不显示)" value="<?php  echo $item['advurl_pc'];?>" name="advurl_pc">
                                <span class="input-group-btn">
                                    <button class="btn btn-default nav-link" type="button" data-id="PAL-00010" >选择链接</button>
                                </span>
                            </div>
                            <?php  } else { ?>
                             <div class='form-control-static'><?php  echo $item['advurl_pc'];?></div>
                             <?php  } ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">pc首页图片标签1</label>
                        <div class="col-sm-9 col-xs-12">
                            <?php if( ce('shop.category' ,$item) ) { ?>
                            <?php  echo tpl_form_field_image('advtitle1', $item['advtitle1'])?>
                            <span class="help-block">建议尺寸: 300*640</span>
                            <?php  } else { ?>
                            <?php  if(!empty($item['advtitle1'])) { ?>
                            <a href='<?php  echo tomedia($item['advtitle1'])?>' target='_blank'>
                            <img src="<?php  echo tomedia($item['advtitle1'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                            </a>
                            <?php  } ?>
                            <?php  } ?>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">pc首页图片标签2</label>
                        <div class="col-sm-9 col-xs-12">
                            <?php if( ce('shop.category' ,$item) ) { ?>
                            <?php  echo tpl_form_field_image('advtitle2', $item['advtitle2'])?>
                            <span class="help-block">建议尺寸: 300*640</span>
                            <?php  } else { ?>
                            <?php  if(!empty($item['advtitle2'])) { ?>
                            <a href='<?php  echo tomedia($item['advtitle2'])?>' target='_blank'>
                            <img src="<?php  echo tomedia($item['advtitle2'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                            </a>
                            <?php  } ?>
                            <?php  } ?>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">pc首页图片标签3</label>
                        <div class="col-sm-9 col-xs-12">
                            <?php if( ce('shop.category' ,$item) ) { ?>
                            <?php  echo tpl_form_field_image('advtitle3', $item['advtitle3'])?>
                            <span class="help-block">建议尺寸: 300*640</span>
                            <?php  } else { ?>
                            <?php  if(!empty($item['advtitle3'])) { ?>
                            <a href='<?php  echo tomedia($item['advtitle3'])?>' target='_blank'>
                            <img src="<?php  echo tomedia($item['advtitle3'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                            </a>
                            <?php  } ?>
                            <?php  } ?>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">pc首页图片标签4</label>
                        <div class="col-sm-9 col-xs-12">
                            <?php if( ce('shop.category' ,$item) ) { ?>
                            <?php  echo tpl_form_field_image('advtitle4', $item['advtitle4'])?>
                            <span class="help-block">建议尺寸: 300*640</span>
                            <?php  } else { ?>
                            <?php  if(!empty($item['advtitle4'])) { ?>
                            <a href='<?php  echo tomedia($item['advtitle4'])?>' target='_blank'>
                            <img src="<?php  echo tomedia($item['advtitle4'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                            </a>
                            <?php  } ?>
                            <?php  } ?>
                        </div>
               ...
               <?php  if(!empty($parentid)) { ?>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">PC端首页推荐</label>
                    <div class="col-sm-9 col-xs-12">
                            <?php if( ce('shop.category' ,$item) ) { ?>
                        ...
                        <div class="dd" id="div_nestable">
                            ...
                            <table class='table'>
                                ...
                                <td>
                                    ...
                                    <a href="<?php  echo $this->createWebUrl('shop/category',array('op' => 'post'))?>" class="btn btn-primary"><i class="fa fa-plus"></i> 添加新分类</a>
                                    <?php  } ?>
