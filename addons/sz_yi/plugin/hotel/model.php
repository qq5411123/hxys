...
if (!class_exists('HotelModel')) {
	class HotelModel extends PluginModel
	{
		...
		public function getRoomPrice($hotelid, $roomid, $date)
		{
			...
			if (empty($roomprice)) {
				...
				$roomprice = array('roomid' => $roomid, 'oprice' => $room['oprice'], 'cprice' => $room['cprice'], 'mprice' => $room['mprice'], 'status' => $room['status'], 'roomdate' => strtotime($date), 'thisdate' => $date, 'num' => '-1', 'status' => 1);
			}
	...
	'hotel' => array(
		...
		'isplugin' => true,
		'child'    => array(
			'room_status' => array('text' => '房量/房态管理', 'view' => '浏览', 'edit' => '编辑-log'),
			'room_price'  => array('text' => '房价管理', 'view' => '浏览', 'edit' => '编辑-log'),
			'meet'        => array('text' => '会议预约', 'view' => '浏览', 'edit' => '编辑-log'),
			'rest'        => array('text' => '餐饮预约', 'view' => '浏览', 'edit' => '编辑-log'),
			'prints'      => array('text' => '打印机设置', 'view' => '浏览', 'edit' => '编辑-log')
			)
		)
	);
		}
