...
if ($_W['isajax']) {
	...
	if ($_W['ispost']) {
		...
		$apply = array('uid' => $uid, 'type' => $_GPC['type'], 'applysn' => $applyno, 'apply_money' => $costmoney, 'apply_time' => $time, 'status' => 0, 'uniacid' => $_W['uniacid'], 'apply_ordergoods_ids' => $apply_ordergoods_ids);
