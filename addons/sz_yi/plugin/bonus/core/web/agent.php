...
if ($operation == 'display') {
	...
	'columns' => array(
		...
		array('title' => '下线总数', 'field' => 'levelcount', 'width' => 12),
		array('title' => '累计分红佣金', 'field' => 'commission_total', 'width' => 12),
		array('title' => '发放分红佣金', 'field' => 'commission_pay', 'width' => 12),
		array('title' => '成为会员时间', 'field' => 'createtime', 'width' => 12),
	...
	if ($operation == 'check') {
		...
		$time = time();
		pdo_update('sz_yi_member', array('bonus_status' => 1), array('id' => $member['id'], 'uniacid' => $_W['uniacid']));
