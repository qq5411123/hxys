...
<title>商品分类</title>
<style type="text/css">
    body {margin:0px;padding:0px; width:100%; height:100%; background:#f9f9f9; color:#fff; }
 .topbar {position:fixed;top:0px;width:100%; height:40px;  background:#fff; border-bottom:1px solid #e8e8e8; font-size:16px; line-height:40px; text-align:center; color:#666;}
   ...
   .search {height:40px;margin-left:30px; color:#ccc; line-height:40px; font-size:14px; text-align:center;}
    ...
    #right_container .inner { margin-right: 90px; background:#fff;overflow: hidden;min-height:100%;padding:10px}
...
<script id='tpl_main' type='text/html'>
   <div class="topbar"><a href="javascript:history.back()"><i class="fa fa-angle-left"></i></a>
    ...
    <div class="search1">
     ...
     <!--<div class="main bg-padding">
         <div class="container-ffbg">
            <div class="container-tit">推荐分类</div>
            <div class="container-list">
                <ul>
                    <li><a href="#"><img src="#" /><br/>分类名称</a></li>
                    <li><a href="#"><img src="#" /><br/>分类名称</a></li>
                    <li><a href="#"><img src="#" /><br/>分类名称</a></li>
                    <li><a href="#"><img src="#" /><br/>分类名称</a></li>
                    <li><a href="#"><img src="#" /><br/>分类名称</a></li>
