...
<div class="panel panel-info">
    <div class="panel-heading">全球分红条件</div>
        ...
        <form action="" method="post" class="form-horizontal" role="form" id="form1">
            ...
            <?php  } else { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12 mart7">
                        <?php  echo $logs_text;?>已发放分红 <?php  echo $logs_count;?> 次
                    </div>
                </div>
                <?php  } ?>
            <div class="form-group" style="text-align: center;">
                <?php if(cv('bonus.sendall.bont')) { ?>
                <div class="col-sm-3 col-lg-2"><button class="btn btn-primary" >全球分红发放</button></div>
                <?php  } ?>
            </div>
            <?php  } ?>
         </form> 
