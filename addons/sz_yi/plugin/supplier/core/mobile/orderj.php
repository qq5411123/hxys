...
if ($_W['isajax']) {
	...
	if ($operation == 'display') {
		return show_json(1, array('openid' => $openid, 'set' => $set, 'member' => $member, 'supplieruser' => $supplieruser, 'uid' => $uid, 'username' => $username, 'type' => $_GPC['type'], 'supplierinfo' => $supplierinfo, 'commission_total' => $commission_total, 'costmoney' => $costmoney, 'commission_ok' => number_format($costmoney, 2)));
	}
}
