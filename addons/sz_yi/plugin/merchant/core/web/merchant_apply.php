...
if ($operation == 'display') {
	...
	'title'   => '待审核佣金' . '数据-' . date('Y-m-d-H-i', time()),
	'columns' => array(
		array('title' => 'ID', 'field' => 'id', 'width' => 12),
		array('title' => '提现单号', 'field' => 'applysn', 'width' => 24),
		array('title' => '粉丝', 'field' => 'nickname', 'width' => 12),
		array('title' => '姓名', 'field' => 'realname', 'width' => 12),
		array('title' => '手机号码', 'field' => 'mobile', 'width' => 12),
		array('title' => '提现方式', 'field' => 'type', 'width' => 12),
		array('title' => '申请佣金', 'field' => 'money', 'width' => 12),
	...
	if ($operation == 'detail') {
		...
		if (!empty($id)) {
			...
			pdo_update('sz_yi_merchant_apply', $data, array('id' => $id, 'uniacid' => $_W['uniacid']));
			$msg = '提现到微信钱包成功!';
