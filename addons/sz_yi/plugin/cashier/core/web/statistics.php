	...
	if ($operation == 'detail') {
		...
		foreach ($list as &$row) {
			if (($row['deredpack'] == 1) && ($row['decommission'] == 1) && ($row['decredits'] == 1)) {
				...
				if (($row['deredpack'] == 1) && ($row['decommission'] == 1) && ($row['decredits'] != 1)) {
					...
					if (($row['decommission'] == 1) && ($row['decredits'] == 1) && ($row['deredpack'] != 1)) {
						$row['text'] = '(已扣除佣金和奖励余额费用)';
					}
					else {
						if (($row['deredpack'] == 1) && ($row['decredits'] == 1) && ($row['decommission'] != 1)) {
			...
			if ($store['redpack_min'] <= $row['price']) {
		...
		if ($_GPC['export'] == 1) {
			...
			$columns = array(
				...
				array('title' => '支付金额(元)', 'field' => 'price', 'width' => 12),
				array('title' => '订单金额(元)', 'field' => 'goodsprice', 'width' => 12),
				array('title' => '结算金额(元)', 'field' => 'realprice', 'width' => 12),
				array('title' => '红包奖励(元)', 'field' => 'redpackmoney', 'width' => 12),
				array('title' => '余额奖励(元)', 'field' => 'creditpackmoney', 'width' => 12),
				array('title' => '一级佣金(元)', 'field' => 'commission1', 'width' => 12),
				array('title' => '二级佣金(元)', 'field' => 'commission2', 'width' => 12),
				array('title' => '三级佣金(元)', 'field' => 'commission3', 'width' => 12),
				array('title' => '平台分成(元)', 'field' => 'platform_poundage', 'width' => 12),
				...
				array('title' => '支付时间', 'field' => 'paytime', 'width' => 24),
				array('title' => '完成时间', 'field' => 'finishtime', 'width' => 24),
				array('title' => '余额抵扣金额(元)', 'field' => 'deductcredit2', 'width' => 12),
				array('title' => '积分抵扣金额(元)', 'field' => 'deductcredit', 'width' => 12),
				array('title' => '优惠券金额', 'field' => 'couponprice', 'width' => 12),
				array('title' => '扣除情况', 'field' => 'text', 'width' => 36)
				);
