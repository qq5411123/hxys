...
.favorite_top {height:44px; background:#e8e8e8; padding:0px 1%; border-bottom:1px solid #e3e3e3;}
.favorite_top .title {height:44px; width:auto; float:left; font-size:16px; line-height:44px; color:#666;}
.favorite_top .nav {height:30px; width:auto; background:#fff; padding:0px 10px; border:1px solid #e3e3e3; border-radius:5px; float:right; line-height:30px; margin:6px 0px 0px 16px; color:#666; font-size:14px;cursor: pointer;}
.favorite_main {height:auto; width:100%;background:#fff;}
.favorite_good {height:100px; width:100%; padding:10px 0px; border-bottom:1px solid #e3e3e3;}
...
.favorite_good .img {height:80px; width:80px; background:#f99; float:left;z-index:2;position: relative;cursor: pointer;}
...
.favorite_good .info .inner .name {height:40px; width:100%; line-height:20px; color:#666; overflow:hidden; font-size:14px;cursor: pointer;}
...
.favorite_good .right { cursor: pointer;float:right;width:30px;height:20px;margin-left:-30px; color:#666;font-size:18px;margin-top:25px;text-align:center;z-index:2;position: relative;}
...
<script id="favorite_main" type="text/html">
      <div class="favorite_top">
        <div class="title" onclick='history.back()'> 我的收藏(<%total%>)</div>
