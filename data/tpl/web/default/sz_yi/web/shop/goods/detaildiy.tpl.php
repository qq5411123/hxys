...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
           ...
           <div class="input-group ">
              <input class="form-control" type="text" data-id="PAL-00010" placeholder="请填写指向的链接 (请以http://开头, 不填则不显示)" value="<?php  echo $item['detail_btnurl1'];?>" name="detail_btnurl1">
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
           ...
           <div class="input-group ">
              <input class="form-control" type="text" data-id="PAL-00020" placeholder="请填写指向的链接 (请以http://开头, 不填则不显示)" value="<?php  echo $item['detail_btnurl2'];?>" name="detail_btnurl2">
              <span class="input-group-btn">
                  <button class="btn btn-default nav-link" type="button" data-id="PAL-00020" >选择链接</button>
              </span>
           </div>
