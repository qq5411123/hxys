...
<div class="panel panel-info">
    <div class="panel-heading">团队分红条件</div>
    <div class="panel-body">
        <form action="" method="post" class="form-horizontal" role="form" id="form1">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 col-lg-9 col-xs-12 mart7">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">打款方式</label>
                    <div class="col-sm-9 col-xs-12 mart7">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label"></label>
                    ...
                    <div class="input-group" style="margin-left:0">
                      已选择自动打款不能操作，自动分红只会分红一次，待分红依旧显示，便于切换为手动分红时打款，选择自动分红请忽略待分红显示
                    </div>
                </div>
            </div>
            <?php  } else { ?>
            <div class="form-group" style="text-align: center;">
                ...
                <div class="col-sm-3 col-lg-2"><button class="btn btn-primary">发放分红</button></div>
                <?php  } ?>
            </div>
            <?php  } ?>
         </form> 
...
<div class="panel panel-default">
    <div class="panel-heading">团队分红总金额：<?php  if(!empty($totalmoney)) { ?><?php  echo $totalmoney;?>元<?php  } else { ?>0元<?php  } ?></div>
    <div class="panel-body">
        <table class="table table-hover">
            <thead class="navbar-inner">
                <tr>
                    <th style='width:10%;'>id</th>
                    <th style='width:14%;'>代理商</th>
                    <th style='width:14%;'>代理等级</th>
