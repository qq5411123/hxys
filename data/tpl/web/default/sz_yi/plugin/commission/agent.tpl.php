        ...
        <form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-lg-9 col-xs-12">
                        <input type="text" class="form-control"  name="realname" value="<?php  echo $_GPC['realname'];?>" placeholder='可搜索昵称/名称/手机号/绑定手机号'/>
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="panel-body">
        <table class="table table-hover table-responsive">
            ...
            <tr>
                ...
                <th style='width:12%;'>分销等级<br/>下级分销商</th>
                <th style='width:8%;'>点击数</th>
                <th style='width:10%;'>累计佣金<br/>打款佣金</th>
                <th style='width:12%;text-align: center'>状态<?php if(cv('commission.agent.check')) { ?><br/>（点击审核)<?php  } ?></th>
            ...
            <tr>
                ...
                <?php  } ?>
                <?php  } else { ?>
                <img src='<?php  echo $row['parentavatar'];?>' style='width:30px;height:30px;padding1px;border:1px solid #ccc' /><br/> <?php  echo $row['parentname'];?>
                <?php  } ?>
                </td>
                <td style="text-align: center;">
                    <?php  if(!empty($row['avatar'])) { ?>
                    <img src='<?php  echo $row['avatar'];?>' style='width:30px;height:30px;padding1px;border:1px solid #ccc' /><br/>
                    <?php  } ?>
                ...
                <td><?php  if(empty($row['levelname'])) { ?> <?php echo empty($this->set['levelname'])?'普通等级':$this->set['levelname']?><?php  } else { ?><?php  echo $row['levelname'];?><?php  } ?>
                    <br/>
...
<?php  echo $row['commission_total'];?></label><br/><label class="label label-danger"><?php  echo $row['commission_pay'];?></label></td>
                <td style="text-align: center">
                    <?php  if($row['status']==0) { ?>
                ...
                <td style="text-align: center">  <?php  if(empty($row['followed'])) { ?>
