...
<?php  if($v1['data_type'] == 9) { ?>
    ...
    citys<?php  echo $i?>[0] = $('#sel-provance').val();
    citys<?php  echo $i?>[1] = $('#sel-city').val();
    citys<?php  echo $i?>[2] = $('#sel-area').val();
    <?php  if($v1['tp_must'] == 1) { ?>
...
'<?php  echo $k1?>_0': $('#field_data<?php  echo $i?>_0').val(),'<?php  echo $k1?>_1': $('#field_data<?php  echo $i?>_1').val(),
