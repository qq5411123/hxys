...
if ($_W['isajax']) {
	...
	if ($_W['ispost']) {
		...
		$apply = array('member_id' => $member['id'], 'type' => $_GPC['type'], 'applysn' => $applyno, 'money' => $center_info['commission_ok'], 'apply_time' => $time, 'status' => 0, 'uniacid' => $_W['uniacid']);
