...
if ($operation == 'display') {
	...
	if ($operation == 'create-order') {
		...
		if (0 < $deductcredit) {
			...
			m('member')->setCredit($openid, 'credit1', 0 - $deductcredit, array('0', '收银台购物积分抵扣 消费积分: ' . $deductcredit . ' 抵扣金额: ' . $deductmoney . ' 订单号: ' . $ordersn));
		}
