...
final class Response
{
	...
	static private function bodyJson($body)
	{
		return \_obf_UWluaXVcanNvbl9kZWNvZGU_((string) $body, true, 512);
	}
	...
	static private function isJson($headers)
	{
