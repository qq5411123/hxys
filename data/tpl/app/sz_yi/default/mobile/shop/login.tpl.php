<?php defined('IN_IA') or exit('Access Denied');?><?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('common/sp_header', TEMPLATE_INCLUDEPATH)) : (include template('common/sp_header', TEMPLATE_INCLUDEPATH));?>
