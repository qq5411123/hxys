...
if (!class_exists('FansModel')) {
	class FansModel extends PluginModel
	{
		...
		public function fetch_token()
		{
			...
			if (!empty($_W['account']['access_token']) && is_array($_W['account']['access_token']) && !empty($_W['account']['access_token']['token']) && !empty($_W['account']['access_token']['expire']) && (TIMESTAMP < $_W['account']['access_token']['expire'])) {
