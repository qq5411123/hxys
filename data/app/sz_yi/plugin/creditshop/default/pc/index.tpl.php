...
<link href="../addons/sz_yi/plugin/creditshop/template/pc/default/images/css.css" rel="stylesheet" type="text/css"/>
<title><?php  echo SZ_YI_INTEGRAL?>商城</title>
...
<script id='tpl_main'  type='text/html'>
    ...
    <%/if%>
    <div class="jf-tit">
        <h2>我的<?php  echo SZ_YI_INTEGRAL?></h2>
        <span>可用<?php  echo SZ_YI_INTEGRAL?><a href="<?php  echo $this->createPluginMobileUrl('creditshop/creditlog')?>"><%credit%></a>分</span>
