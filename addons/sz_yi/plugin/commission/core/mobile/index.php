...
if ($_W['isajax']) {
	...
	$cansettle = (0 < $member['commission_ok']) && (floatval($this->set['withdraw']) <= $member['commission_ok']) && $proportion;
	$mycansettle = (0 < $member['commission_total']) && (floatval($this->set['consume_withdraw']) <= $member['myordermoney']);
