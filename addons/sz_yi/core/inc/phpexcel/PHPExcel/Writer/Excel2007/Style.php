...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
	public function writeStyles(PHPExcel $pPHPExcel = NULL)
	{
		...
		while ($i < $this->getParentWriter()->getNumFmtHashTable()->count()) {
		...
		while ($i < $this->getParentWriter()->getFontHashTable()->count()) {
		...
		while ($i < $this->getParentWriter()->getFillHashTable()->count()) {
		...
		while ($i < $this->getParentWriter()->getBordersHashTable()->count()) {
		...
		while ($i < $this->getParentWriter()->getStylesConditionalHashTable()->count()) {
