...
$_W['shopshare'] = array('title' => !empty($shopset['share']['title']) ? $shopset['share']['title'] : $shopset['shop']['name'], 'imgUrl' => !empty($shopset['share']['icon']) ? tomedia($shopset['share']['icon']) : tomedia($shopset['shop']['logo']), 'desc' => !empty($shopset['share']['desc']) ? $shopset['share']['desc'] : $shopset['shop']['name'], 'link' => $this->createPluginMobileUrl('choose', array('pageid' => $pageid, 'mid' => $member['id'])));
$this->setHeader();
