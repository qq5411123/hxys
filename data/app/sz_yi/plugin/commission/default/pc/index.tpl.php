...
.menu .nav .fa-time {background-color: #5ED1FF;}
...
<script id='tpl_main' type='text/html'>
        ...
        <div class="top-fx">
            <div class="top_2">
                ...
                <div class="pr-jine">
                    ...
                    <a <%if commission_ok<=0 || commission_ok< set.withdraw || member.myordermoney< set.consume_withdraw %>href="javascript:;"<%else%>href="<?php  echo $this->createPluginMobileUrl('commission/apply')?>"<%/if%> id='withdraw' ><span <%if commission_ok<=0 || commission_ok< set.withdraw%>class='disabled'<%/if%> ><?php  echo $this->set['texts']['withdraw']?></span></a>
                </div>
            </div>
            <div class="top_1">
                <div class="text">
                <?php  echo $this->set['texts']['commission_total']?>：<%member.total_all%> 元</div>
    ...
    <div class="menu">  
        ...
        <!--分红-->
        <?php  if($bonus==1) { ?>
        <a href="<?php  echo $this->createPluginMobileUrl('bonus/withdraw')?>"><div class="nav nav1"><i class="fa fa-cny fa-3x" style="color:#7775FF;"></i><div class="title"><?php  echo $bonus_set['texts']['commission1']?></div><div class="con"><span><?php  echo $member_bonus['commission_total'];?></span> 元</div></div></a>
        <?php  if($level) { ?>
        <a href="<?php  echo $this->createPluginMobileUrl('bonus/order')?>"><div class="nav nav1"><i class="fa fa-list fa-3x" style="color:#40BD56;"></i><div class="title"><?php  echo $bonus_set['texts']['order']?></div><div class="con"><span><?php  echo $member_bonus['ordercount0'];?></span> 个</div></div></a>
        <?php  } ?>
        <?php  if($member['bonus_area']) { ?>
        <a href="<?php  echo $this->createPluginMobileUrl('bonus/order_area')?>"><div class="nav nav1"><i class="fa fa-list fa-3x" style="color:#A6D044;"></i><div class="title"><?php  echo $bonus_set['texts']['order_area']?></div><div class="con"><span><?php  echo $member_bonus['ordercount_area0'];?></span> 个</div></div></a>
        <?php  } ?>
        <a href="<?php  echo $this->createPluginMobileUrl('bonus/log')?>"><div class="nav nav1"><i class="fa fa-random  fa-3x" style="color:#FF3D3D;"></i><div class="title"><?php  echo $bonus_set['texts']['commission_detail']?></div><div class="con"><?php  echo $bonus_set['texts']['commission']?>明细</div></div></a>        
        <a href="<?php  echo $this->createPluginMobileUrl('bonus/customer')?>"><div class="nav nav1"><i class="fa fa-users  fa-3x" style="color:#F758C6;"></i><div class="title"><?php  echo $bonus_set['texts']['mycustomer']?></div><div class="con"><span><?php  echo $member_bonus['customercount'];?></span> 人</div></div></a> 
        <!--/分红-->
        <?php  } ?>
        ...
        <a href="#"><div class="nav nav1"><i class="fa fa-time fa-3x" style="color:#ff9901;"></i><div class="title">订单总计</div><div class="con"><span><%pricecount%></span> 元</div></div></a>    
    </div>
</script>
