...
if ($operation == 'display') {
	...
	if (checksubmit('submit')) {
		...
		$data = array('uniacid' => $_W['uniacid'], 'level' => $_GPC['level'], 'levelname' => $_GPC['levelname'], 'agent_money' => floatval($_GPC['agent_money']), 'commissionmoney' => $_GPC['commissionmoney'], 'ordermoney' => $_GPC['ordermoney'], 'ordercount' => intval($_GPC['ordercount']), 'downcount' => intval($_GPC['downcount']), 'downcountlevel1' => intval($_GPC['downcountlevel1']), 'downcountlevel2' => intval($_GPC['downcountlevel2']), 'downcountlevel3' => intval($_GPC['downcountlevel3']), 'content' => intval($_GPC['content']), 'premier' => intval($_GPC['premier']), 'pcommission' => floatval($_GPC['pcommission']), 'msgtitle' => trim($_GPC['msgtitle']), 'msgcontent' => trim($_GPC['msgcontent']), 'status' => intval($_GPC['status']));
